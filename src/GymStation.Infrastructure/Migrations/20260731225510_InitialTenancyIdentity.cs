    ...
    public partial class InitialTenancyIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    GymId = table.Column<Guid>(type: "uuid", nullable: false),
                    SubstitutionMode = table.Column<int>(type: "integer", nullable: false),
                    OpenClaimsEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    CheckInWindowMinutes = table.Column<int>(type: "integer", nullable: false),
                    AccentColorHex = table.Column<string>(type: "character varying(9)", maxLength: 9, nullable: false),
                    DefaultThemeDark = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymSettings", x => x.GymId);
                    table.ForeignKey(
